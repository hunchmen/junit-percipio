...
public class Employee03 {
    ...
    public Employee03(String firstName, String lastName, int id, char gender,
    ...
    public void adjustSalary(double adjAmount) {
        ...
        if (adjAmount > 5000) {
            System.out.println(
                    "The increment exceeds the limit. Applying a 5K increase.");
            adjAmount = 5000;
        }

        System.out.println("Updating salary from " + salary + " to "
                + (salary + adjAmount));
